...
$query="insert into tbltestrecord(PatientMobileNumber,VaccinationType,TestTimeSlot,OrderNumber) values('$mnumber','$Vaccinationtype','$timeslot','$orderno');";
  ...
  <div class="row">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                        ...
                                        <div class="form-group">
                                               <label>Hopital</label>
                                            <input type="text" class="form-control" id="hospital" name="hospital" value="<?php echo $result['hospital']; ?>" readonly="true">
                                        </div>
